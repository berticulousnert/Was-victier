module.exports = {
   ...
   $createObject[$jsonRequest[https://api.bloxban.com/place/ban_upload?game_id=$getGuildVar[placeId]&auth=$get[Decrypted_auth]&data={"rbx_id":$getObjectProperty[data[0].id] ,"ban_reason":"$replaceText[$message;$message[1];]","ban_time":1,"ban_note":"No note lol check ban message"}]]
    $color[1;#C3A78E]
