...
$onlyif[$getguildvar[Cookie]!=Null;{newEmbed: {description:**No Cookie currently set. You can set one by using the /setup or -setcookie command.**}{color:#E6E6FA}{footer:If you think this is a problem you may contact a developer.}}]
