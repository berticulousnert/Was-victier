module.exports = {
    ...
    $addField[1;Promote;> Promote's a roblox user in a group make sure to use the setup command!( has a slash command ) <3\n> **Server invite:** None? ;true]
    $addField[1;Demote;> Does the opposite of Promote pretty self explanitory. ( has a slash command ) <3\n> **Server invite:** None? ;true]
    ...
    $addField[1;Userinfo;> Uses roblox API to fetch info about you. 🫵🏽 ( has a slash command ) <3\n> **Server invite:** None? ;true]
    ...
    $addField[1;Setcookie;> The roblox account cookie being used for ranking here's a **[tutoral](https://www.youtube.com/watch?v=eUd47kPxZvQ)**. *Not my video* ( has a slash command ) <3\n> **Server invite:** None? ;true]
    $addField[1;Setgroupid;> Uses to groupid to identify which group the account is going to rank in. ( has a slash command ) <3\n> **Server invite:** None? ;true]
    $addField[1;Setplaceid;> Place id used for banning/unbanning users to know how click **[this](https://www.youtube.com/watch?v=ugvlmK6w_ng)** ( has a slash command ) <3\n> **Server invite:** None? ;true]
